...
// `dataCadastro` é preenchida automaticamente no momento em que o admin
// cadastra o usuário na plataforma (somente leitura).
const dadosFixos = {
  nomeCompleto: "Ana Beatriz Souza",
  cpf: "123.456.789-00",
  matricula: "PT-EQ-0042",
  oab: "SP 345.678",
  dataCadastro: "12/03/2023",
};
      ...
      <Card>
        ...
        <CardContent>
          <form className="grid gap-4 sm:grid-cols-2" onSubmit={onSubmit}>
            ...
            <ReadonlyInput label="Data de cadastro" value={dadosFixos.dataCadastro} />
