import { UserCircle, Inbox, BarChart3, LogOut } from "lucide-react";
...
const items = [
  { title: "Meu perfil", url: "/area-interna/perfil", icon: UserCircle, end: true },
  { title: "Pedidos", url: "/area-interna/pedidos", icon: Inbox },
  { title: "Financeiro", url: "/area-interna/financeiro", icon: BarChart3 },
];
